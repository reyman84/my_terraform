...
/*resource "aws_subnet" "public_subnet_1d" {
  ...
  map_public_ip_on_launch = true
  tags = {
    Name = "Terraform - Public Subnet 1d"
  }
}
...
resource "aws_subnet" "public_subnet_1e" {
  ...
  map_public_ip_on_launch = true
  tags = {
    Name = "Terraform - Public Subnet 1e"
  }
}
...
resource "aws_subnet" "public_subnet_1f" {
  ...
  map_public_ip_on_launch = true
  tags = {
    Name = "Terraform - Public Subnet 1f"
  }
}*/
...
resource "aws_subnet" "private_subnets" {
  for_each = {
    "us-east-1a" = var.private_subnet["1"]
    "us-east-1b" = var.private_subnet["2"]
    "us-east-1c" = var.private_subnet["3"]
  }
  ...
  tags = {
    Name = "Terraform - Private Subnet: ${each.key}"
  }
}
